...
(function($, undefined){
    ...
    function _Append(container, settings){
    ...
    function _Show(container, settings){
        ...
        $(".loadingoverlay").show().fadeIn(settings.fade[0]);
    }
    ...
    function _Hide(container, force){
        ...
        if (force || count <= 0) {
            ...
            $(".loadingoverlay").fadeOut(container.data("LoadingOverlayFadeOutDuration"), function(){
            	$(".loadingoverlay").hide();
            });
        } else {
            container.data("LoadingOverlayCount", count);
